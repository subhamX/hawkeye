        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:shadow-lg transition-all duration-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-slate-700 dark:text-slate-300">AWS Accounts</CardTitle>
                <div className="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/30">
                  <Server className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-slate-900 dark:text-white">{totalAccounts}</div>
            ...
            <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:shadow-lg transition-all duration-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-slate-700 dark:text-slate-300">Enabled Services</CardTitle>
                <div className="p-2 rounded-lg bg-purple-100 dark:bg-purple-900/30">
                  <Database className="h-4 w-4 text-purple-600 dark:text-purple-400" />
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-slate-900 dark:text-white">{enabledServicesCount}</div>
                <p className="text-xs text-slate-600 dark:text-slate-400">
            ...
            <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:shadow-lg transition-all duration-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-slate-700 dark:text-slate-300">Potential Savings</CardTitle>
            ...
            <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:shadow-lg transition-all duration-200">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-slate-700 dark:text-slate-300">Last Analysis</CardTitle>
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
              <h2 className="text-xl font-semibold text-slate-900 dark:text-white">AWS Accounts</h2>
            ...
            <div className="grid gap-6">
              {accounts.map((account) => (
                <Card key={account.id} className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 hover:shadow-lg transition-all duration-200">
                  <CardHeader>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                      <div>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                      <div>
                        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Enabled Services</p>
                      ...
                      <div>
                        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Regions</p>
                        <p className="text-sm text-slate-600 dark:text-slate-400">
                      ...
                      <div>
                        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Last Analysis</p>
                        <p className="text-sm text-slate-600 dark:text-slate-400">
                      ...
                      <div>
                        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">Potential Savings</p>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 pt-4 border-t border-slate-200/50 dark:border-slate-700/50 space-y-3 sm:space-y-0">
                      ...
                      <Button variant="ghost" size="sm" asChild className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-700">
                        <Link href={`/dashboard/account/${account.id}`}>
            ...
            {accounts.length === 0 && (
              <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                <CardContent className="py-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-slate-900 dark:text-white">No AWS Accounts Connected</h3>
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white/50 dark:bg-slate-800/50">
                  <h4 className="font-medium mb-2 text-slate-900 dark:text-white">RDS Optimization</h4>
                ...
                <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white/50 dark:bg-slate-800/50">
                  <h4 className="font-medium mb-2 text-slate-900 dark:text-white">Lambda Cost Analysis</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
                ...
                <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white/50 dark:bg-slate-800/50">
                  <h4 className="font-medium mb-2 text-slate-900 dark:text-white">CloudFront Analytics</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
                ...
                <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white/50 dark:bg-slate-800/50">
                  <h4 className="font-medium mb-2 text-slate-900 dark:text-white">ELB Optimization</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
                ...
                <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white/50 dark:bg-slate-800/50">
                  <h4 className="font-medium mb-2 text-slate-900 dark:text-white">Reserved Instances</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
                ...
                <div className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white/50 dark:bg-slate-800/50">
                  <h4 className="font-medium mb-2 text-slate-900 dark:text-white">Cost Anomaly Detection</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
              ...
              <div className="mt-4 p-4 bg-slate-100/50 dark:bg-slate-700/50 rounded-lg">
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  ...
                  <Link href="mailto:feedback@hawkeye.com" className="text-blue-600 dark:text-blue-400 hover:underline ml-1">
                    Let us know!
                  </Link>
                </p>
              </div>
