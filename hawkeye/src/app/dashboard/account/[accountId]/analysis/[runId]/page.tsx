  ...
  return (
    <ProtectedRoute>
      <DashboardLayout 
        ...
        showBackButton={true}
        backHref={`/dashboard/account/${params.accountId}`}
        ...
        <div className="space-y-8">
          ...
          <Tabs defaultValue="s3" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
              <TabsTrigger value="s3" className="flex items-center gap-2 data-[state=active]:bg-blue-100 dark:data-[state=active]:bg-blue-900/30 data-[state=active]:text-blue-700 dark:data-[state=active]:text-blue-300">
                <Database className="h-4 w-4" />
                <span className="hidden sm:inline">S3 Storage Analysis</span>
                <span className="sm:hidden">S3</span>
              </TabsTrigger>
              <TabsTrigger value="ec2" className="flex items-center gap-2 data-[state=active]:bg-purple-100 dark:data-[state=active]:bg-purple-900/30 data-[state=active]:text-purple-700 dark:data-[state=active]:text-purple-300">
                <HardDrive className="h-4 w-4" />
                <span className="hidden sm:inline">EC2/EBS Analysis</span>
                <span className="sm:hidden">EC2</span>
              </TabsTrigger>
              <TabsTrigger value="insights" className="flex items-center gap-2 data-[state=active]:bg-cyan-100 dark:data-[state=active]:bg-cyan-900/30 data-[state=active]:text-cyan-700 dark:data-[state=active]:text-cyan-300">
              ...
              <TabsContent value="s3" className="space-y-6">
                ...
                <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                  <CardContent className="text-center py-8">
                    ...
                    <h3 className="font-semibold mb-2 text-slate-900 dark:text-white">No S3 Analysis Data</h3>
            ...
            <TabsContent value="ec2" className="space-y-6">
              {ec2Results ? (
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                      <CardHeader>
                        <CardTitle className="text-slate-900 dark:text-white">EC2 Utilization</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="text-2xl font-bold text-slate-900 dark:text-white">
                          {ec2Results.utilizationRecommendations?.length || 0}
                    ...
                    <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                      <CardHeader>
                        <CardTitle className="text-slate-900 dark:text-white">Unused EBS Volumes</CardTitle>
                      </CardHeader>
                      <CardContent>
                  ...
                  <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                    <CardHeader>
                      <CardTitle className="text-slate-900 dark:text-white">EC2 Recommendations</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <RecommendationsTable 
                  ...
                  <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                    <CardHeader>
                      <CardTitle className="text-slate-900 dark:text-white">EBS Recommendations</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <RecommendationsTable 
              ...
              <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                <CardContent className="text-center py-8">
                  <AlertTriangle className="h-12 w-12 mx-auto mb-4 text-slate-400 dark:text-slate-500" />
                  <h3 className="font-semibold mb-2 text-slate-900 dark:text-white">No EC2/EBS Analysis Data</h3>
                  <p className="text-slate-600 dark:text-slate-400">
