        ...
        json_schema_extra = {
            "example": {
                ...
                "input_data": {
                    ...
                    "work_scope": '''Do not check for anything in Route53 and Kinesis.'''
                }
            }
        }
...
async def start_job(data: StartJobRequest):
    ...
    try:
        ...
        input_text = f"account_id: {data.input_data['aws_account_id']}, work_scope: {data.input_data['work_scope']}"
        ...
        "input_data": [
            {
                ...
                "data": {
                    ...
                    "placeholder": "For example: 123456789012"
                }
            },
            {
                "id": "work_scope",
                ...
                "name": "Work Scope",
                "data": {
                    "description": "The work scope to check",
                    "placeholder": "For example: Do not check for anything in Route53 and Kinesis."
                }
            }
        ]
    }
