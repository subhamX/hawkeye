          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      AWS Infrastructure Analysis Made Simple
                    </span>
                ...
                >
                  AWS HawkEye: Your Infrastructure Guardian
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Get comprehensive insights into your AWS infrastructure with
                  our intelligent agents. Analyze EC2, S3, and CloudFormation
                  resources for security, performance, and cost optimization.
                </TextEffect>
                <AnimatedGroup
                  variants={{
                    container: {
