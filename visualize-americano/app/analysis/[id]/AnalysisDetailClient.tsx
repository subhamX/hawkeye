                    ...
                    >
                        ...
                        <div className="w-32 h-32 mx-auto">
                            <CircularProgressbar
                                value={securityScore}
                                maxValue={10}
                                text={`${securityScore}/10`}
                                styles={buildStyles({
                                    pathColor: securityScore >= 7 ? '#00C49F' : securityScore >= 4 ? '#FFBB28' : '#FF8042',
                                })}
                            />
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="w-32 h-32 mx-auto">
                            <CircularProgressbar
                                ...
                                maxValue={10}
                                text={`${performanceScore}/10`}
                                styles={buildStyles({
                                    pathColor: performanceScore >= 7 ? '#00C49F' : performanceScore >= 4 ? '#FFBB28' : '#FF8042',
                                })}
                            />
                        </div>
                    </motion.div>
        ...
        return (
            ...
            >
                ...
                <motion.div 
                    ...
                    variants={itemVariants}
                >
                    <h3 className="text-lg font-medium mb-4">Storage Metrics</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                            <p className="text-sm text-gray-600">Total Objects</p>
                            <p className="text-2xl font-bold">{data.total_objects?.toLocaleString()}</p>
                        </div>
                        <div className="text-center">
                            <p className="text-sm text-gray-600">Total Size</p>
                            <p className="text-2xl font-bold">{(data.total_size / (1024 * 1024 * 1024)).toFixed(2)} GB</p>
                        </div>
                    </div>
                </motion.div>
            </motion.div>
            ...
            <div className="container mx-auto px-4 pt-32 pb-16">
                <div className="mx-auto max-w-4xl">
                    ...
                    <div className="space-y-12">
                        ...
                        {initialData.awss3hawk?.[0] && renderS3Analysis(initialData.awss3hawk[0])}
                    </div>
                </div>
            </div>
        </main>
